...
<html>
  ...
  <body>
	...
	return this.push.apply(this, rest);
      ...
      var keysDown = {}; //Object to hold which keys are pressed
      var ready = false; //Boolean if game is ready
      var updateInterval;
      var medTimeout;

      /**
       * Generates a medicine and sends it to the server
       */
	...
	medTimeout = setTimeout(generateMedicine, Math.floor((Math.random() * 10000) + 1000));
      ...
      /**
       * Callback when message is received through websockets
       * Parameters
	...
	delete keysDown[e.keyCode];
       ...
       *  o {Object} other object (bullet or medicine)
       */
	...
	return plane.x < o.x + o.width &&
      ...
      /**
       * Update game based on keys, send message to server
       */
      function update() {
	if (87 in keysDown) {
	  if (myPlane == 1) {
	...
	if (13 in keysDown && canFire) {
      ...
      /**
       * "Repaint" game on canvas
       * Parameters
       *  data {Object} contains game data
       */
